...
{
	public static final int INTERNET_ENABLING_REQUEST_CODE = 1983;
	public static final int GPS_ENABLING_REQUEST_CODE = 1984;
	public static final int GooglePlayServicesREQUESTCODE = 10;
	...
	public static final String PREFS_MAPTYPE = "mapType";
	public static final String PREFS_ZOOMLEVEL = "zoomLevel";
	public static final int GPS_REFRESH_RATE = 10000;
