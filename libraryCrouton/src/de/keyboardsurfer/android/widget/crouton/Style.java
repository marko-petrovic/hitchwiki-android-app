...
public class Style {
  ...
  //Hitchwiki style
  public static final Style HITCHWIKI;
  ...
  static {
    ...
    INFO = new Builder()
      ...
      .build();
    HITCHWIKI = new Builder()
	    .setBackgroundColorValue(Color.argb(150, 0, 0, 0))
	    .build();
  }
  ...
  public static class Builder {
    ...
    public Builder() {
      ...
      isTileEnabled = false;
      textColorResourceId = android.R.color.holo_orange_light;
