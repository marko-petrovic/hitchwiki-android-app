...
public class Options {
	...
	/**
	 * Map zoom level can not be smaller than this value. This is added to adjust poor performances of 
	 * GoogleMaps with huge amount of markers, so at this zoom level we assume that map
	 * still works correctly as bounding screen shows reasonable number of markers 
	 * NOTE FROM FEB 24
	 * this is set from options menu in the app. default value here is still 6 but as soon as Clusterkraf
	 * gets initialized, we set it to prefs reading for zoomLevel
	 */
	public static int MINIMAL_ZOOM_LEVEL = 6;
	...
	public static int getMinimalZoomLevel() {
		return MINIMAL_ZOOM_LEVEL;
	}

	public int getMINIMAL_ZOOM_LEVEL() {
		return MINIMAL_ZOOM_LEVEL;
	}

	public void setMINIMAL_ZOOM_LEVEL(int mINIMAL_ZOOM_LEVEL) {
		MINIMAL_ZOOM_LEVEL = mINIMAL_ZOOM_LEVEL;
	}
